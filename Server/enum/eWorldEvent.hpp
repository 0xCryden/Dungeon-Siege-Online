...
#define EWORLDEVENT_HPP_
	...
	inline string ToString (eWorldEvent e)
	{
		switch (e)
		{
			...
			case we_player_data_changed: return "we_player_data_changed";
			...
			case we_weapon_launched: return "we_weapon_launched";
			case we_weapon_swung: return "we_weapon_swung";
			case we_projectile_hit: return "we_projectile_hit";
